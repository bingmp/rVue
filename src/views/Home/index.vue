<template>
  ...
  >
    <el-tab-pane label="Home" name="id1">
      <el-card>
        <div class="box">
          ...
          <div>
            ...
            <div>
              <p>
                ...
                which can be used for various data analysis and visualization
                Data shows below:
              </p>
              <ul>
                <li>Omics:</li>
    ...
    <el-tab-pane label="GEO data" name="id2">
      <geoDataTable />
    </el-tab-pane>
    <el-tab-pane label="Sample" name="id3">
      <geoGroupTable />
    </el-tab-pane>
    <el-tab-pane label="Rshiny" name="id4">
      <Rshiny />
    </el-tab-pane>
    <el-tab-pane label="Lab. introduction" name="id5">
      <LabInfo />
    </el-tab-pane>
  </el-tabs>
</template>
...
import geoDataTable from './geoDataTable.vue'
import geoGroupTable from './geoGroupTable.vue'
